...
remove_groups = [
    'CCc1cc2c(cc1C(F)(F)F)N(CCNC(=O)OC(C)(C)C)CCCC2N(Cc1cc(C(F)(F)F)cc(C(F)(F)F)c1)c1nnn(C)n1', 
    'COc1ccccc1C1C(C(=O)OC(C)C)=C(C(F)(F)F)N=C2SC=C(CC(=O)NCc3ccncc3)N21', 
    'COc1ccc(S(=O)(=O)N(Cc2c(C(C)C)nn(-c3ccccc3)c2Oc2cccc(F)c2)CC2CCCO2)cc1', 
    '[2H]c1c([2H])c([2H])c(C(Oc2c([2H])c([2H])c([2H])c([2H])c2C([2H])([2H])[2H])C([2H])([2H])C([2H])([2H])NC([2H])([2H])[2H])c([2H])c1[2H]', 
    'CCCC(OC(=O)C(Cc1ccc(O)c(C(C)(C)C)c1)C(=O)OC(C)(C)C)(C1CC(C)(C)N(C)C(C)(C)C1)C1CC(C)(C)N(C)C(C)(C)C1', 
    'CCOc1c(OC)cccc1C1C(C(=O)OCCOC)=C(C)N=c2sc(=Cc3c(OCc4ccccc4)ccc4ccccc34)c(=O)n21', 
    'CCN1C(=O)C2=C(CC13CC3)OC1=C(C(=O)CC(C)(C)C1)C2c1c(OC)ccc(-c2ccc(C)c(C(=O)O)n2)c1C', 
    'CC1=CC(C)(c2c(C)c(N=[N+]=[N-])c3c(c2-c2cccc4c2Cc2ccccc2-4)-c2c(cccc2C2CC2)C3)C(C)=C1C', 
    'COc1ccc(C(c2[nH]ncc2C=C(Cc2cc3c(cc2OC)OCO3)C(=O)O)C2CC2)c(OCc2ccccc2C(=O)O)c1', 
    'CCNC(=O)C(C)N(Cc1ccccc1F)C(=O)CN(c1ccc(Cl)c(C(F)(F)F)c1)S(=O)(=O)c1ccc(C)cc1', 
    'O=S(=O)(OC(OS(=O)(=O)c1ccc2ccccc2c1)(OS(=O)(=O)c1cccc2ccccc12)c1ccccc1)c1ccccc1', 
    'CCC(C(=O)NC(C)C)N(Cc1ccc(OC)cc1)C(=O)CN(c1ccccc1OC)S(=O)(=O)c1ccccc1', 
    'FC(F)(F)N(C(F)(F)C(F)(F)F)C(F)(F)C(F)(C(F)(F)F)C(F)(F)C(F)(C(F)(F)F)C(F)(F)F', 
    'COc1cc(CC(=O)NN(c2ccccc2N2CCCCC2)c2ccccc2S(=O)c2ccccc2)c(Br)cc1C(=O)O', 
    'COC(=O)c1ccccc1NC(=O)C1CN(S(=O)(=O)c2ccccc2)CCN1S(=O)(=O)c1ccccc1', 
    '[2H]c1c([2H])c([2H])c(C([2H])(CC([2H])([2H])NC([2H])([2H])[2H])Oc2c([2H])c([2H])c([2H])c([2H])c2C([2H])([2H])[2H])c([2H])c1[2H]', 
    'Cc1cc2c(cc1C(F)(F)F)N(Cc1ccc(CC(=O)O)cc1)CCCC2N(Cc1cc(C(F)(F)F)cc(C(F)(F)F)c1)c1nnn(C)n1', 
    'CCOC(=O)C1=C(c2ccccc2)N=C2SC=C(CC(=O)NCCc3ccccn3)N2C1c1ccccc1OC', 
    'CC(C(=O)NC(C)(C)C)N(Cc1ccc(Cl)c(Cl)c1)C(=O)CN(c1cc(C(F)(F)F)ccc1Cl)S(=O)(=O)c1ccccc1', 
    'c1ccc(-n2c3cc4c(cc3c3ccc5ccccc5c32)c2ccccc2n4C2=Nc3ccccc3NC2c2ccc3ccccc3c2)cc1', 
    'CC(C(=O)NCc1ccc(Cl)cc1Cl)N(Cc1ccc(F)cc1)C(=O)CN(Cc1ccccc1)S(C)(=O)=O', 
    'CCOC(=O)C1=C(C)NC(SCC(=O)Nc2cc(C)ccc2C)=NC1c1cc(OC)c(OC)c(OC)c1', 
    'COc1ccc(CN(C(=O)CCc2ccc(S(=O)(=O)NC3CC3)cc2)C(C)C(=O)NCc2ccc3c(c2)OCO3)cc1', 
    'FC(F)(F)C(F)(F)OC(F)(C(F)(F)F)C(F)(C(F)(C(F)(F)F)C(F)(F)F)C(F)(C(F)(F)F)C(F)(F)F', 
    'COc1cc(C2N=C(SCc3cccc4ccccc34)NC(C)=C2C(=O)Nc2ccccc2)cc(OC)c1OC', 
    'CCC(C(=O)NC(C)C)N(Cc1cccc(OC)c1)C(=O)CN(c1ccc(F)c(Cl)c1)S(=O)(=O)c1ccccc1', 
    'CCC(C(=O)NC(C)C)N(Cc1ccc(OC)cc1)C(=O)CN(c1cc(Cl)ccc1Cl)S(=O)(=O)c1ccc(C)cc1', 
    'CCNC(=O)C(C)N(Cc1ccccc1F)C(=O)CN(c1ccc(Cl)c(C(F)(F)F)c1)S(=O)(=O)c1ccccc1', 
    'CNC(=O)C(C)N(Cc1ccc(OC)cc1)C(=O)CN(c1cccc(Cl)c1Cl)S(=O)(=O)c1ccc(C)cc1', 
    'COc1cc(C2C3=C(CC(C)(C)CC3=O)Nc3ccccc3N2CC(=O)N2CCC(C(N)=O)CC2)cc(OC)c1OC', 
    'CCc1nn(-c2ccc(F)cc2)c(Oc2cccc(C)c2)c1CN(CC1CCCO1)S(=O)(=O)c1ccc(OC)cc1', 
    'CN(C)CCN(Cc1ccccc1)C(=O)c1ccccc1CN1CC(CC(=O)O)CN(Cc2ccc(Cl)cc2Cl)C1=O', 
    'COc1ccc(CN(C(=O)c2ccc(Br)c(OC)n2)C(CON2C(=O)c3ccccc3C2=O)c2cc3c(C)cccc3o2)cc1', 
    'Cc1cc(C(=O)CSc2nnc(-c3cccnc3)n2-c2cccc(C(F)(F)F)c2)c(C)n1CC1CCCO1', 
    'CCNC(=O)C(C)N(Cc1cccc(Cl)c1)C(=O)CN(c1cccc(C(F)(F)F)c1)S(=O)(=O)c1ccccc1', 
    'CCNC(=O)C(C)N(Cc1cccc(Cl)c1)C(=O)CN(c1cccc(Cl)c1Cl)S(=O)(=O)c1ccc(C)cc1', 
    'CCOc1c(OC)cccc1C1C(C(=O)OCCOC)=C(C)N=c2sc(=Cc3c(OCc4ccc(Cl)cc4)ccc4ccccc34)c(=O)n21', 
    'CC(C)CNC(=O)C(Cc1ccccc1)N(Cc1c(Cl)cccc1Cl)C(=O)CCCN1c2cccc3cccc(c23)S1(=O)=O', 
    'C#CC(O)=CC1=C(Cn2c3ccccc3c3ccccc32)N(c2nc(-c3ccccc3)nc(-c3ccccc3)n2)C2C(O)=C(O)C(O)=C12', 
    'COc1c(O)c2c(c(O)c1OC)C(O)(O)C(O)(C(O)(O)C1(O)C(O)(O)C(O)(O)N(C(O)(O)c3ccccc3)C(O)(O)C1(O)O)C2=O'
]
...
model.load_state_dict(torch.load('results_RSA_spherenet/best_model.pt'))
model.to(device)
...
targets, outputs = evaluate_classification_loop(model, test_loader, device, batch_size = 1000, dataset_size = len(test_dataset), is_binary=False)

results_df = deepcopy(test_dataframe[['ID', 'SMILES_nostereo', 'RSA_class']])
results_df['targets'] = targets
results_df['outputs'] = np.argmax(outputs, axis=1)
